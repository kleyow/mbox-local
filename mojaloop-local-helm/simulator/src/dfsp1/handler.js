...
exports.putQuotesById = function (request, h) {
  ...
  Logger.info(`IN PAYERFSP:: PUT /dfsp1/quotes/${request.params.id}, PAYLOAD: [${JSON.stringify(request.payload)}]`)
...
exports.getcorrelationId = function (request, h) {
  ...
  Logger.info(`IN dfsp1:: Final response for GET /dfsp1/correlationid/${request.params.id}, CACHE: [${JSON.stringify(responseData)}`)
...
exports.getQuotesById = function (request, h) {
  ...
  Logger.info(`IN dfsp1:: PUT callback for GET /dfsp1/quotes/${request.params.id}, CACHE: [${JSON.stringify(responseData)}`)
...
exports.getRequestById = function (request, h) {
  ...
  Logger.info(`IN dfsp1:: PUT /dfsp1/requests/${request.params.id}, CACHE: [${JSON.stringify(responseData)}]`)
...
exports.getCallbackById = function (request, h) {
  ...
  Logger.info(`IN dfsp1:: PUT /dfsp1/callbacks/${request.params.id}, CACHE: [${JSON.stringify(responseData)}]`)
