...
exports.getcorrelationId = function (request, h) {
  ...
  Logger.info(`IN dfspmad:: Final response for GET /dfspmad/correlationid/${request.params.id}, CACHE: [${JSON.stringify(responseData)}`)
...
exports.getQuotesById = function (request, h) {
  ...
  Logger.info(`IN dfspmad:: PUT callback for GET /dfspmad/quotes/${request.params.id}, CACHE: [${JSON.stringify(responseData)}`)
...
exports.getRequestById = function (request, h) {
  ...
  Logger.info(`IN dfspmad:: PUT /dfspmad/requests/${request.params.id}, CACHE: [${JSON.stringify(responseData)}]`)
...
exports.getCallbackById = function (request, h) {
  ...
  Logger.info(`IN dfspmad:: PUT /dfspmad/callbacks/${request.params.id}, CACHE: [${JSON.stringify(responseData)}]`)
