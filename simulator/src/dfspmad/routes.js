...
module.exports = [
  ...
  {
    method: 'PUT',
    path: '/dfspmad/participants/{type}/{id}',
  ...
  {
    method: 'PUT',
    path: '/dfspmad/transfers/{id}/error',
