...
module.exports = [
  ...
  {
    method: 'PUT',
    path: '/dfspeur/participants/{type}/{id}',
  ...
  {
    method: 'PUT',
    path: '/dfspeur/transfers/{id}/error',
