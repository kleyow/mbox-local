...
exports.getcorrelationId = function (request, h) {
  ...
  Logger.info(`IN dfsp2:: Final response for GET /dfsp2/correlationid/${request.params.id}, CACHE: [${JSON.stringify(responseData)}`)
...
exports.getQuotesById = function (request, h) {
  ...
  Logger.info(`IN dfsp2:: PUT callback for GET /dfsp2/quotes/${request.params.id}, CACHE: [${JSON.stringify(responseData)}`)
...
exports.getRequestById = function (request, h) {
  ...
  Logger.info(`IN dfsp2:: PUT /dfsp2/requests/${request.params.id}, CACHE: [${JSON.stringify(responseData)}]`)
...
exports.getCallbackById = function (request, h) {
  ...
  Logger.info(`IN dfsp2:: PUT /dfsp2/callbacks/${request.params.id}, CACHE: [${JSON.stringify(responseData)}]`)
